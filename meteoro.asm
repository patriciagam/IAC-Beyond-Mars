...
desenha_linha:
	...
	JZ   fim_desenha_linha   ; se sim, sai do loop
	JMP  desenha_linha   	 ; continua o loop para desenhar a próxima coluna

; desenha linha final do meteoro 
ultima_linha:
	MOV  R1, LINHA + 2    	 ; proxima linha
	MOV  R2, COLUNA       	 ; coluna inicial
	MOV  R5, LARGURA      	 ; largura inicial
	MOV	R4, DEF_BONECO
	ADD	R4, 2
	CALL desenha_pixels   	 ; desenha a ultima linha do meteoro
